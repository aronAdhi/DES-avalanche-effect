...
def encrypt(pt, rkb, rk):
	...
	for i in range(0, 16):
		...
		if(i != 15):
			...
			enc = bin2hex(left)+bin2hex(right)
			intermediate.append(enc)
		# print("'",bin2hex(left)+bin2hex(right)+"',")
...
def DES(pt,key):
	...
	intermediate.append(cipher_text)
...
#3 bit change
#keys = ["013898371520F75E", "E13898371520F75E", "D13898371520F75E", "B13898371520F75E", "713898371520F75E"]
# 4 bit change
